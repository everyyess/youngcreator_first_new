...
export function AssetPriceChart({ name, ticker, history }: { name: Underlying; ticker: UnderlyingTicker; history: readonly DailyPrice[] }) {
  ...
  return <article className="asset-chart">
    ...
    ><ResponsiveContainer><ComposedChart data={data}><XAxis dataKey="date" tickFormatter={shortDate} minTickGap={46} /><YAxis yAxisId="price" tickFormatter={wonFull} width={76} domain={domain} /><Tooltip cursor={false} content={dragging ? () => null : <PriceTooltip color={color} />} /><Legend />
      ...
      <Line yAxisId="price" type="monotone" dataKey="close" stroke={color} strokeWidth={2.3} dot={false} name="종가" />{options.ma && <><Line yAxisId="price" dataKey="sma20" stroke="#F25536" dot={false} name="SMA 20" /><Line yAxisId="price" dataKey="ema12" stroke="#00B5CD" dot={false} name="EMA 12" strokeDasharray="4 3" /></>}{options.trend && <><Line yAxisId="price" dataKey="support" stroke="#00B5CD" dot={false} name="지지 추세선" strokeDasharray="6 3" /><Line yAxisId="price" dataKey="resistance" stroke="#B23A1F" dot={false} name="저항 추세선" strokeDasharray="6 3" /></>}{options.ichimoku && <><Line yAxisId="price" dataKey="tenkan" stroke="#7B5CC7" dot={false} name="전환선" /><Line yAxisId="price" dataKey="kijun" stroke="#B23A1F" dot={false} name="기준선" /><Line yAxisId="price" dataKey="chikou" stroke="#697888" dot={false} name="후행스팬" strokeDasharray="3 3" /></>}</ComposedChart></ResponsiveContainer></div>
