      ...
      {state.error ? (
        ...
        <div className="flex w-full min-w-0 max-w-full items-stretch overflow-hidden rounded-lg border border-slate-100">
          <button
            ...
            className="w-7 shrink-0 border-r border-slate-100 bg-white text-xs font-black text-blue-700 transition hover:bg-blue-50 disabled:cursor-not-allowed disabled:text-slate-300 disabled:hover:bg-white"
            aria-label="이전 지표 보기"
          >
            &lt;
          </button>
          <div className="flex min-w-0 flex-1 flex-nowrap">
            {visibleItems.map((item) => (
              <div key={item.symbol} className="box-border min-w-0 flex-1 overflow-hidden border-r border-slate-100 px-1 py-2 last:border-r-0">
          ...
          <button
            ...
            className="w-7 shrink-0 bg-white text-xs font-black text-blue-700 transition hover:bg-blue-50 disabled:cursor-not-allowed disabled:text-slate-300 disabled:hover:bg-white"
            aria-label="다음 지표 보기"
          >
            &gt;
          </button>
            ...
            return (
              <div key={event.id} className="rounded-lg border border-slate-100 bg-slate-50 px-3 py-2">
                ...
                <p className="line-clamp-2 text-sm font-black text-slate-800">
                  <span className="mr-1 rounded-full bg-white px-2 py-0.5 text-[10px] font-black text-blue-700">{display.market}</span>
                  {display.title}
                </p>
              </div>
            );
